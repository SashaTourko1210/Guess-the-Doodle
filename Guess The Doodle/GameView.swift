...
struct GameView: View {
    ...
    var promptGroup: some View {
        VStack {
            if matchManager.currentlyDrawing {
                Label("RYSUJ:", systemImage: "exclamationmark.bubble.fill")
                    .font(.title2)
                    .bold()
                ...
                HStack {
                    Label("ZGADNIJ RYSUNEK:", systemImage: "exclamationmark.bubble.fill")
                        .font(.title2)
                        .bold()
                        .foregroundColor(Color("primaryPurple"))
                ...
                HStack {
                    TextField("Wpisz swoją odpowiedź", text: $drawingGuess)
                        .padding()
                        .background(
